...
class CanvasExporter:
    ...
    def convert_to_markdown(self, canvas_data: Dict[str, Any], canvas_content: Optional[str]) -> str:
        ...
        if "date_create" in canvas_data:
            create_date = datetime.fromtimestamp(canvas_data["date_create"]).strftime("%Y-%m-%d %H:%M:%S")
            markdown_lines.append(f"**Created:** {create_date}\n")
        
        if "date_update" in canvas_data:
            update_date = datetime.fromtimestamp(canvas_data["date_update"]).strftime("%Y-%m-%d %H:%M:%S")
    ...
    def export_canvas(self, canvas_data: Dict[str, Any], canvas_content: Optional[str]) -> str:
